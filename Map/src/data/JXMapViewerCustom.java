...
public class JXMapViewerCustom extends JXMapViewer {
    ...
    private boolean draw(Path2D p2, RoutingData d, boolean first) { // Add 'first' parameter
        for (GHPoint3D t : d.getPointList()) {
        ...
        return first; // Return updated 'first' value
    }
}
